...
void setup() {
  ...
  setPwmFrequency(3,1042);// pins 3, 9, 10, and 11 have base frequency of 31250 Hz. Choosing 30 Hz as our desired frequency, 1042=31250Hz/30Hz
  setPwmFrequency(9,1042);
  setPwmFrequency(10,1042);
  setPwmFrequency(11,1042);
  
  setPwmFrequency(3,2084);//pins 5 and 6 have a base frequency of 62500 Hz. Choosing 30 Hz as our desired frequency, 2084=62500Hz/30Hz 
  setPwmFrequency(3,2084);
